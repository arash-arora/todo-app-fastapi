...
async def change_password(request: Request):
    ...
    return templates.TemplateResponse("password-change.html", {"request":request, "user": user})
...
async def user_password_change(request: Request, username: str=Form(...), password: str=Form(...), password2: str=Form(...), db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("password-change.html", {"request": request, "user": user, "msg": msg})
